...
function init() {
  ...
  queue.loadManifest([
    ...
    {id:"fireEffect", src:"assets/grenade-launcher.mp3"},
    {id:"explosionEffect", src:"assets/bomb.mp3"},
    {id:"trackOne", src:"assets/tours-enthusiast.mp3"}
  ]);
...
function handleComplete() {
  ...
  soundtrackProps = new createjs.PlayPropsConfig().set({loop: -1, volume: 0.5});
  if (soundtrack) {
    soundtrack = false;
    setTimeout(() => {
