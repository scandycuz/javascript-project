...
function nextLevel() {
  ...
  setTimeout( () => {
    ...
    level++;
    console.log(`level complete is ${levelComplete}`);
    levelComplete = true;
    console.log(`now level complete is ${levelComplete}`);
...
function won() {
  return levelComplete === false && orbs.length === 0;
}
...
function tick(event) {
  ...
  if (won()) {
    console.log(`won, and level complete is ${levelComplete}`);
